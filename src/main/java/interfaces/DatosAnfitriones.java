 ...
 * @author Alejandro
 */
public class DatosAnfitriones extends javax.swing.JFrame {

    /**
     * Creates new form DatosAnfitriones
     */
    public DatosAnfitriones() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Datos de Anfitriones");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DatosAnfitriones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DatosAnfitriones().setVisible(true);
            }
        });
    }
